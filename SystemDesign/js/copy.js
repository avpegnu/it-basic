/* Copy code button + Chapter jump menu — System Design pillar */

(function () {
  const CHAPTERS = [
    { num: '01', title: 'Scalability Fundamentals',                      file: 'chuong1.html' },
    { num: '02', title: 'Load Balancer & Reverse Proxy',                 file: 'chuong2.html' },
    { num: '03', title: 'Caching Strategies',                            file: 'chuong3.html' },
    { num: '04', title: 'Database Scaling & Data Patterns',              file: 'chuong4.html' },
    { num: '05', title: 'Message Queue & Async Communication',           file: 'chuong5.html' },
    { num: '06', title: 'Microservices vs Monolith',                     file: 'chuong6.html' },
    { num: '07', title: 'CDN, Rate Limiting, API Gateway, Security',     file: 'chuong7.html' },
    { num: '08', title: 'Design Case Studies',                           file: 'chuong8.html' },
  ];
